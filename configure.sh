...
echo ''
read -p "Do you want to use ronniehicks' dotfiles? y/n" -n 1 -r
echo    # (optional) move to a new line
if [[ $REPLY =~ ^[Yy]$ ]]
then
    echo ''
	echo "Now pulling down ronniehicks dotfiles..."
    ...
    if [[ $? -eq 0 ]]
    then
        echo "Successfully configured your environment with ronniehicks' dotfiles..."
    else
        echo "ronniehicks' dotfiles were not applied successfully..." >&2
fi
else 
	echo ''
    echo "You chose not to apply ronniehicks' dotfiles. You will need to configure your environment manually..."
	echo ''
