...
echo "› re-installing powerlevel9k theme into $CUSTOM_DIR/themes/powerlevel9k"
...
echo "› re-installing zsh-autosuggestions into ${CUSTOM_DIR}/plugins/zsh-autosuggestions"
...
echo "› re-installing zsh-syntax-highlighting into ${CUSTOM_DIR}/plugins/zsh-syntax-highlighting"
...
echo "› re-installing zsh-nvm into ${CUSTOM_DIR}/plugins/zsh-nvm"
